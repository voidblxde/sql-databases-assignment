...
P.S.
Лично я во время выполнения пользовался встроенным в WebStorm интерфейсом управления базами данных. Это мне удобнее, нагляднее и привычнее(как фронтендеру).